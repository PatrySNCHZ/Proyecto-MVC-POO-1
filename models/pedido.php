...
class Pedido {
    ...
    public function getOneByUser() {
        $sql = "SELECT p.id, p.coste FROM pedidos p "
                . "INNER JOIN pedidos_producto pp ON pp.pedido_id = p.id "
...
//    $sql = "SELECT * FROM  productos WHERE id IN (SELECT producto_id FROM pedidos_producto "
//            . "WHERE  pedido_id=($id))";
    
    $sql = "SELECT pr.*, pp.unidades FROM productos pr "
            ."INNER JOIN pedidos_producto  pp ON pr.id = pp.producto_id "
...
//        }
    ...
    public function save_linea() {
        ...
        foreach ($_SESSION['carrito'] as $elemento) {
            ...
            $insert = "INSERT INTO pedidos_producto VALUES(NULL,{$pedido_id}, {$producto->id}, {$elemento['unidades']})";
